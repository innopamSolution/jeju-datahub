    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ flex: 1, position: 'relative', minWidth: 0, background: '#eaeef2' }}>
          ...
          {timelineVisible && (
            <div style={{ position: 'absolute', top: 56, left: 12, right: 52, zIndex: 9, background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(8px)', border: '1px solid var(--ant-border-secondary)', borderRadius: 12, boxShadow: '0 4px 18px rgba(0,0,0,0.12)', padding: '10px 18px 14px' }}>
